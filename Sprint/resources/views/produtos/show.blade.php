...
<div class="max-w-3xl">
    <div class="flex items-center gap-3 mb-6">
        ...
        <h2 class="text-xl font-semibold text-white">Detalhes do Produto</h2>
    </div>
    ...
    <div class="bg-gray-900 rounded-xl border border-gray-800 shadow-md p-6 space-y-6">
        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
            <div>
                ...
                <p class="mt-1 text-base font-medium text-white">{{ $produto->nome }}</p>
            </div>
            <div>
                <p class="text-sm text-gray-400">Valor</p>
                <p class="mt-1 text-base font-medium text-white">R$ {{ number_format($produto->valor, 2, ',', '.') }}</p>
            </div>
            <div>
                <p class="text-sm text-gray-400">Cor</p>
                <p class="mt-1 text-base font-medium text-white">{{ $produto->cor }}</p>
            </div>
            <div class="sm:col-span-2">
                <p class="text-sm text-gray-400">Quantidade em Estoque</p>
                <p class="mt-1 text-base font-medium text-white">{{ $produto->quantidade_estoque }}</p>
            </div>
        </div>
