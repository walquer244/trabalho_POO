...
<div class="max-w-xl">
    <div class="flex items-center gap-3 mb-6">
        ...
        <h2 class="text-xl font-semibold text-white">Cadastrar Produto</h2>
    </div>
    ...
    <div class="bg-gray-900 rounded-xl border border-gray-800 shadow-md p-6">
        <form action="{{ route('produtos.store') }}" method="POST" class="space-y-4">
            ...
            <div>
                ...
                <input id="nome" type="text" name="nome" value="{{ old('nome') }}" required placeholder="Ex: Chuteira Nike"
            ...
            <div>
                ...
                <input id="valor" type="number" name="valor" value="{{ old('valor') }}" step="0.01" min="0.01" required placeholder="0.00"
                    class="w-full bg-gray-800 border rounded-lg px-3 py-2.5 text-sm text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent transition
            ...
            <div>
                ...
                <input id="cor" type="text" name="cor" value="{{ old('cor') }}" required placeholder="Ex: Preto/Branco"
                    class="w-full bg-gray-800 border rounded-lg px-3 py-2.5 text-sm text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent transition
