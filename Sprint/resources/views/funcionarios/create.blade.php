...
<div class="max-w-xl">
    <div class="flex items-center gap-3 mb-6">
        ...
        <h2 class="text-xl font-semibold text-gray-800">Cadastrar Funcionário</h2>
    </div>
    ...
    <div class="bg-white rounded-xl border border-gray-200 shadow-sm p-6">
        <form action="{{ route('funcionarios.store') }}" method="POST" class="space-y-4">
            ...
            <div>
                ...
                <input id="funcao" type="text" name="funcao" value="{{ old('funcao') }}" required placeholder="Ex: Vendedor, Gerente, Estoquista..."
                    class="w-full border rounded-lg px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent transition
